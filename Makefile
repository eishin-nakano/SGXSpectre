...
CC=gcc
CXX=g++
CCASFLAGS=-g -O0 -Wall -Werror -std=gnu99 -fno-strict-aliasing -fno-strict-overflow -D_FORTIFY_SOURCE=2 -fstack-protector-all -DHAVE_GNU_STACK -Wno-implicit-function-declaration
CFLAGS=-g -O0 -Wall -Werror -std=gnu99 -fno-strict-aliasing -fno-strict-overflow -D_FORTIFY_SOURCE=2 -fstack-protector-all -DHAVE_GNU_STACK -Wno-pointer-sign
CXXFLAGS=-g -O0 -Wall -Werror -std=c++17 -fno-strict-aliasing -fno-strict-overflow -D_FORTIFY_SOURCE=2 -fstack-protector-all -DHAVE_GNU_STACK -pthread -fopenmp
CPPFLAGS=-D_DEFAULT_SOURCE -D_BSD_SOURCE -D_POSIX_SOURCE -D_GNU_SOURCE -DNO_SYSLOG -DCOMPILE_WITH_INTEL_SGX 
DEFS=
INCLUDE=-I. -I/home/eishin-nakano/.local/include/SEAL-4.1 #自分の環境に合わせて変更
...
App_Link_Flags := $(SGX_COMMON_CFLAGS) -L$(SGX_LIBRARY_PATH) -l$(Urts_Library_Name) -L/home/eishin-nakano/.local/lib -lseal-4.1
...
main.o: enclave_u.o main/main.cpp
	cd main && $(CXX) -g -O0 -pthread -fPIC -DPIC $(App_C_Flags) -I$(SGX_SDK)/include -c main.cpp -o $@ 
	@echo "CC   <=  $<"
